...
class Chart2Vec(nn.Module):
    ...
    """
    def __init__(self, rep_size=10*MAX_SEMANTIC_LEN, hidden_dropout_prob=0.1,last_rep_size=200):
    ...
    def forward(self, struct_one_hot,indexed_tokens,fact_pos_id):
        semantic_embed=self.semantic_embedding(indexed_tokens)
        # concat  + 2 dense
        fusion_tensor=self.fc(semantic_embed)
...
class SemanticEmbedding(nn.Module):
    ...
    def forward(self, indexed_token, ):
